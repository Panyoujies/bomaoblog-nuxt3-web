...
<template>
  ...
  <div class="reply-card reply-item default">
    <div class="reply-avatar">
      <div class="popover-box user-popover">
        <a href="/user/1345457962892861" target="_blank">
          <div class="avatar jj-avatar avatar">
            <img :src="comment?.member?.avatar ?? isQQEmail(props.comment?.member?.email as string) ? qqAvatar : '/assets/images/avatar.png'" :alt="comment?.member?.nickName + '的头像'" class="lazy avatar-img" loading="lazy">
          </div>
        </a>
      </div>
    </div>
    <div class="reply-wrapper">
      <div class="reply-content">
        <div class="content">
          <div class="user-info">
            <div class="popover-box user-popover">
              <a href="/user/1345457962892861" target="_blank" class="username username">
                <span class="name" style="max-width: 120px;">{{ comment.member.nickName }}</span>
              </a>
            </div>
            <span>:</span>
          </div>
