...
<!--          <div class="action-reply" :class="isReply ? 'active' : ''" @click="openReply(!isReply)">
            <svg class="icon" fill="none" height="14" viewBox="0 0 16 16" width="14" xmlns="http://www.w3.org/2000/svg">
...
<!--        <div class="reply" v-if="isReply">
          <comment-submit comment-type="reply" :article-id="comment?.articleId" :parent-comment-id="comment?.commentId" />
        </div>-->
<!--        <div class="comment-reply-wrapper">
          <div class="reply-list default">
            <comment-reply v-for="item in comment?.children" :key="item.commentId" :comment="item"/>
            <div class="top-has-more default">
              <span>
                查看全部 35 条回复
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M5.99976 7.93206L10.0656 3.86619C10.1633 3.76856 10.3215 3.76856 10.4192 3.86619L10.7727 4.21975C10.8704 4.31738 10.8704 4.47567 10.7727 4.5733L6.35331 8.99272C6.15805 9.18798 5.84147 9.18798 5.6462 8.99272L1.22679 4.5733C1.12916 4.47567 1.12916 4.31738 1.22679 4.21975L1.58034 3.86619C1.67797 3.76856 1.83626 3.76856 1.93389 3.86619L5.99976 7.93206Z"></path>
                </svg>
              </span>
            </div>
          </div>
